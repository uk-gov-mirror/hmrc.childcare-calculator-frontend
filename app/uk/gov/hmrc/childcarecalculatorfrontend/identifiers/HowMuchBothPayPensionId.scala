...
case object HowMuchBothPayPensionId extends Identifier with CacheKey {
  override def toString: String = "howMuchBothPayPension"

  override type CacheValue = HowMuchBothPayPension
}
