...
case object DoesYourPartnerGetAnyBenefitsId extends Identifier with CacheKey {
  override def toString: String = "doesYourPartnerGetAnyBenefits"

  override type CacheValue = Set[ParentsBenefit]
}
