...
case object AreYouSelfEmployedOrApprenticeId extends Identifier with CacheKey {
  override def toString: String = "areYouSelfEmployedOrApprentice"

  override type CacheValue = EmploymentStatus
}
