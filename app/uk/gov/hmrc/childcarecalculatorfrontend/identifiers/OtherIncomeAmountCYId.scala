...
case object OtherIncomeAmountCYId extends Identifier with CacheKey {
  override def toString: String = "otherIncomeAmountCY"

  override type CacheValue = OtherIncomeAmountCY
}
