...
import uk.gov.hmrc.childcarecalculatorfrontend.models.enums.{Age, YesNoNotSure}

case class Claimant(
    ageRange: Option[Age] = None,
    benefits: Set[ParentsBenefit] = Set.empty,
    ...
    escVouchers: Option[YesNoNotSure] = None,
